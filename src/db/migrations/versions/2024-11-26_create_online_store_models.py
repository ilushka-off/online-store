"""create_online_store_models

Revision ID: 8d1008c8dcd3
Revises:
Create Date: 2024-11-26 20:18:45.092137
...
revision: str | None = "8d1008c8dcd3"
...
def upgrade() -> None:
    ...
    op.create_index(op.f("addresses_id_idx"), "addresses", ["id"], unique=False)
    op.create_table(
        "categories",
    ...
    op.create_table(
        ...
        sa.UniqueConstraint("number", name=op.f("products_number_key")),
    )
...
def downgrade() -> None:
    ...
    op.drop_index(op.f("addresses_id_idx"), table_name="addresses")
